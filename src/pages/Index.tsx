...
function ROICalculator() {
  ...
  const disorderCost = Math.round(
    teamSize * 1200 + monthlyRevenue * 0.08 + toolsCount * 3500
  );
  const potentialGain = Math.round(disorderCost * 0.65);

  return (
    <section className="py-24 bg-praxia-surface border-y border-praxia-border">
      <div className="container mx-auto max-w-7xl px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-praxia-muted max-w-xl mx-auto">
            Calcula el costo estimado de operar sin sistemas. Introduce los datos de tu empresa.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-praxia-surface-2 border border-praxia-border rounded-sm p-8 flex flex-col gap-8">
            ...
            <div>
              ...
              <input
                type="range" min={50} max={5000} step={50} value={monthlyRevenue}
            ...
            <div>
              ...
              <input
                type="range" min={1} max={15} value={toolsCount}
          ...
          <div className="flex flex-col gap-6">
            <div className="bg-praxia-surface-2 border border-red-900/40 rounded-sm p-6">
              <p className="text-praxia-muted text-sm mb-1">Costo mensual estimado del desorden</p>
              <p className="text-4xl font-black text-red-400">
                ${disorderCost.toLocaleString("es-MX")} MXN
              </p>
              <p className="text-xs text-praxia-muted mt-2">
                Incluye horas perdidas, errores operativos y oportunidades no capturadas.
              </p>
            </div>

            <div className="bg-praxia-surface-2 border border-praxia-blue/40 rounded-sm p-6">
              <p className="text-praxia-muted text-sm mb-1">Potencial de recuperación con sistemas</p>
              <p className="text-4xl font-black text-praxia-blue-light">
                ${potentialGain.toLocaleString("es-MX")} MXN/mes
              </p>
              <p className="text-xs text-praxia-muted mt-2">
                Estimado basado en resultados promedio de clientes implementados.
              </p>
            </div>

            <Link
              to="/contacto"
              className="inline-flex items-center justify-center gap-2 py-4 rounded-sm bg-gradient-blue text-white font-semibold hover:opacity-90 transition-opacity"
            >
              Quiero recuperar ese valor <ArrowRight size={16} />
            </Link>
          </div>
        </div>
      </div>
